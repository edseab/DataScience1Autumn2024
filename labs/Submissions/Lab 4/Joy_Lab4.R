...
mtcars$wt<- mtcars$wt * 0.453592*1000
...
hist(mtcars$wt, 
     main = "Histogram of Car Weights (kg)", 
     xlab = "Weight (kg)", 
     col = "lightblue", 
     border = "black")
#density
plot(density(mtcars$wt), 
     main = "Density Plot of Car Weights (kg)", 
     xlab = "Weight (kg)", 
     col = "darkblue", 
     lwd = 2)
...
barplot (barplot_d, beside=T, ylim=c(0,1), main = "Proportion of Survivors by sex and class", 
     xlab = "Class", ylab = 'Proportions', col = c('red', 'blue'), legend = c('Male', 'Female'))
