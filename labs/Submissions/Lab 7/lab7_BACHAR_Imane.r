...
# This indicates that number of cylinders partially confounds the relationship between car weight and car efficiency. 
# Once cylinders are controlled for, the effect of weight on efficiency is less pronounced, although still important and significant.
