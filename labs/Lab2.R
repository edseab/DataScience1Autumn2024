...
rownames(trilogy_matrix ) <- c("The phantom menace", "attack of clones", "revenge of sith")
colnames(trilogy_matrix ) <- c("US revenue", "International revenue")
...
binomial_function <- function(n,p,k){
...
men_heights <- c(134,153,198,189,190,200,197) ## Populate with the heights of men from class
women_heights <- c(165,168,162,161,160) ## Populate with the heights of women from class
