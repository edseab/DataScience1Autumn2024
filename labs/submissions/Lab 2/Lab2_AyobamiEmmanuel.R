...
prequel <- matrix(c(phantom_menace, attack_of_clones, revenge_of_sith), byrow=3, nrow =3)
rownames(prequel) <- c("The Phantom Menace", "Attack of Clones", "Revenge of Sith")
prequel <- cbind(prequel, rowSums(prequel))
prequel
star_wars_matrix <- rbind(star_wars_matrix, prequel)
star_wars_matrix
