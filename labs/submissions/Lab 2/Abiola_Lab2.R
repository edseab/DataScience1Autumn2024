...
men_heights <- c(172, 173, 179, 182, 185) ## Populate with the heights of men from class
women_heights <- c(159, 162, 165, 168, 171) ## Populate with the heights of women from class
