...
logjil <- matrix(c(phantom_menace, attack_of_clones,revenge_of_sith),byrow = T, nrow = 3)
logjil
total_revenue2 <- rowSums(logjil)
total_revenue2
logjil <- cbind(logjil,total_revenue2)
rownames(logjil) <- c("phantom menace", "attack of clones", "revenge of smith")
