...
rownames(trilogy_matrix)<-c("The Phantom Menace","The Attack of Clones", "The Revenge of Sith")
colnames(trilogy_matrix)<-c("US revenue","International revenue", "Total revenue")
...
uni_simulation<-rbinom(100000,20,0.7)
perc_below_12<-mean(uni_simulation<=11)*100
#Since the calculated percentage for 11 or less signals is 11.3%, there is a decent likelyhood that the number of probes signalling Water will be 11 or fewer.
...
women_heights <- c(163, 155, 164, 159, 166, 152) ## Populate with the heights of women from class
...
#This is because t-test considers both tails, and the p-value formula in the function considers only one tail
