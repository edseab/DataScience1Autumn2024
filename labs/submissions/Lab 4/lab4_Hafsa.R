...
plot(x,y,type='h') # histogram-like plot
...
hist(mtcars$wt_kg, main = "Histogram of Car Weights in kg", xlab = "Weight (kg)", col = "lightblue")

plot(density(mtcars$wt_kg), main = "Density Plot of Car Weights in kg", xlab = "Weight (kg)", col = "lightblue")
...
barplot(barplot_d, beside = TRUE, col = c("lightblue", "pink"), ylim = c(0, 1),
        main = "Survival Proportions on the Titanic by Class and Sex",
        xlab = "Class", ylab = "Survival Proportion")
...
#Answer: Females had a significantly higher survival rate than males across all classes. The least likely group to survive was the second-class males.
